...
CXXUnaryOperatorCheck::CXXUnaryOperatorCheck(
    StringRef Name, GrayCContext *Context)
    : GrayCCheck(Name, Context) {}


void CXXUnaryOperatorCheck::registerMatchers(MatchFinder *Finder) {
  Finder->addMatcher(unaryOperator().bind("unary-operator"), this);
}

void CXXUnaryOperatorCheck::check(
...
bool CXXUnaryOperatorCheck::mutateUnaryOperator(
