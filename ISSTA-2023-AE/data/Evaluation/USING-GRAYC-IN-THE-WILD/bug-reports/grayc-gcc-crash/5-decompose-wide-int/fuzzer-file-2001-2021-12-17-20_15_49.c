...
l0:;
  ...
  if (((int)v0 != (3) + (42) *((long)((((int)((0xCF00))) <<((int)((0))))))+((long)((((int)((0))) ^((int)((-1))))))))
    goto l3;
  c[(-1)].r = *d;
  v1 = -(-2) + (-43) +((long)((((int)(-(-2))) |((int)(-(17))))))-((short)((((int)(v1)) &((int)(v1)))))+((short)((((int)(v1)) %((int)(-(1))))));
  e = c[(0)].r;
  if ((0))
    g (a, "");
  ...
  goto l4;
l3:;
  c[(16)].i = v0 + (43) -((long)((((int)(v0)) >>((int)(c[(0)].i)))))+((int)((((int)(c[(0)].i)) >>((int)(v0)))));
  e = c[(0x7C)].r;
  if ((-1))
    g (a, "");
  e = c[(16)].r;
  if ((8589934592))
    g (a, "");
  k = e + (6) + (42) -((long)((((int)((2))) >>((int)((130))))))+((int)((((int)((-3))) &((int)((0x28))))))*((int)((((int)((-3))) <<((int)((0x05AC))))))-((int)((((double)((130))) *((double)((0x6))))));
  k->r = c[(-2)].r;
l4:;
}
