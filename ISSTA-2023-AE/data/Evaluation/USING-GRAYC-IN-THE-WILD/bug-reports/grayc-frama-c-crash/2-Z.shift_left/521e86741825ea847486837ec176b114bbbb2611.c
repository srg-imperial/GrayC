               ...
               char *buf, int len)
{
  ...
  (((osection)->vma = (osection)->lma= (vaddr) + (-43) +((int)((((double)((osection)->lma)) *((double)((osection)->vma)))))*((short)((((double)((osection)->vma)) *((double)((vaddr))))))*((long)((((double)((osection)->vma)) -((double)((osection)->vma)))))-((long)((((int)((osection)->vma)) ^((int)((osection)->lma)))))-((short)((((double)((osection)->lma)) -((double)((vaddr))))))), ((osection)->user_set_vma = (boolean)true + (-43) +((long)((((double)((osection)->user_set_vma)) *((double)((osection)->user_set_vma)))))*((int)((((double)((osection)->user_set_vma)) +((double)((boolean)true)))))*((short)((((double)((osection)->user_set_vma)) -((double)((osection)->user_set_vma)))))*((short)((((int)((boolean)true)) |((int)((boolean)true)))))+((short)((((int)((boolean)true)) &((int)((boolean)true)))))-((short)((((int)((boolean)true)) ^((int)((osection)->user_set_vma)))))*((long)((((double)((osection)->user_set_vma)) -((double)((osection)->user_set_vma)))))-((short)((((int)((boolean)true)) %((int)((osection)->user_set_vma)))))+((short)((((int)((boolean)true)) >>((int)((boolean)true)))))), true);
  (((osection)->alignment_power = ((-1)) + (-43) +((long)((((double)(((-1)))) -((double)(((-1)))))))+((short)((((double)(((-1)))) +((double)(((-1)))))))+((long)((((int)((osection)->alignment_power)) >>((int)((osection)->alignment_power)))))+((int)((((double)((osection)->alignment_power)) +((double)((osection)->alignment_power)))))+((long)((((int)(((-1)))) ^((int)(((-1)))))))-((int)((((double)(((-1)))) +((double)((osection)->alignment_power)))))*((short)((((int)((osection)->alignment_power)) ^((int)(((-1)))))))+((short)((((double)((osection)->alignment_power)) -((double)(((-1)))))))-((short)((((int)(((-1)))) <<((int)(((-1)))))))-((short)((((double)(((-1)))) *((double)(((-1)))))))),true);
  bfd_set_section_flags (obfd, osection, (0));
  osection->entsize = (-1) + (-43) *((short)((((int)((-1))) |((int)(osection->entsize)))))+((int)((((double)((-1))) +((double)(osection->entsize)))));
...
bfd_set_section_contents (bfd *abfd, asection *section, void * data, file_ptr offset, bfd_size_type count)
{
	if (((int)count != (bfd_size_type)(0) + (-43) +((int)((((int)(count)) %((int)((bfd_size_type)(0))))))*((long)((((double)(count)) -((double)(count)))))*((long)((((double)(count)) *((double)((bfd_size_type)(0))))))))
		abort();
}
