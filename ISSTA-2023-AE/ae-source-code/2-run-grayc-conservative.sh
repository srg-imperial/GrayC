...
seeds=/home/user42/seeds/seeds_out2.txt
...
echo "Starts GrayC Fuzzer (Conservative mode) $curr_ts and will end at $end_ts"
...
while IFS= read -r seed ; do
  ...
  echo "Running GrayC Fuzzer (Conservative mode) with seed $seed $timestamp"
  (bin/grayc-conservative $setA -detect_leaks=0 -max_len=1000000 -rss_limit_mb=4096 -create_missing_dirs=1 -ignore_crashes=1 -ignore_timeouts=1 -ignore_ooms=1 -seed=$seed -timeout=50 -max_total_time=86400)
...
echo "DONE: bin/grayc-conservative $setA ... "
